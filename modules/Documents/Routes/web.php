...
Route::middleware(['web', 'auth'])->prefix('admin/documents')->as('documents.admin.')
    ->group(function (): void {
...
Route::middleware(['web'])->prefix('docs')->as('documents.web.')
    ->group(function (): void {
        Route::get('/', WebDocumentController::class)->name('index');
